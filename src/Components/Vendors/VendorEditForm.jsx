                    ...
                    <div className="row signup-container">
                        <div className="col-lg-12">
                            <form className='forms' onSubmit={formik.handleSubmit}>
                                ...
                                {/* <div className='my-3'>
                                    <label htmlFor="companyName" className="form-label d-none">Company Name</label>
                                    <input
                                        type="text"
                                        placeholder='Enter Company Name'
                                        id='companyName'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="ownerName" className="form-label d-none">Vendor Name</label>
                                    <input
                                        type="text"
                                        placeholder='Enter Vendor Name'
                                        id='ownerName'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="gstNumber" className="form-label d-none">gstNumber</label>
                                    <input
                                        type="text"
                                        placeholder='Enter GST NO'
                                        id='gstNumber'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="street" className="form-label d-none">Street</label>
                                    <input
                                        type="text"
                                        placeholder='Enter street'
                                        id='street'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="city" className="form-label d-none">City</label>
                                    <input
                                        type="text"
                                        placeholder='Enter city'
                                        id='city'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="state" className="form-label d-none">State</label>
                                    <input
                                        type="text"
                                        placeholder='Enter state'
                                        id='state'
                                ...
                                <div className='my-3'>
                                    <label htmlFor="pincode" className="form-label d-none">Pincode</label>
                                    <input
                                        type="text"
                                        placeholder='Enter Pincode'
                                        id='pincode'
