          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <ul className="navbar-nav ms-md-auto gap-2">
              ...
              <li className="nav-item dropdown rounded">
                <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i className="bi bi-person-fill me-2"></i>User</a>

                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                  <li ><Link to={"/create-user"} className="dropdown-item">Register new user</Link></li>
                  <li ><Link to={"/user/all"} className="dropdown-item">All users</Link></li>
                </ul>
              </li>
